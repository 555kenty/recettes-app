...
import { Search, X, Plus, ChefHat, Scale, Flame, Beef, Droplets, Wheat } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-serif text-xl font-bold text-stone-900">Comparateur</h1>
            <p className="text-xs text-stone-400">Comparez jusqu&apos;a 3 recettes</p>
          </div>
        </div>
      ...
      {selected.length === 0 && (
        ...
        >
          ...
          <p className="text-stone-500 font-medium mb-1">Aucune recette selectionnee</p>
